...
const mockDictionary: Record<string, DictionaryResponse> = {
  ...
  algorithm: {
    ...
    usage:
      "Common in computing, mathematics, and increasingly in discussions about artificial intelligence and automated systems.",
  },
  serendipity: {
    word: "serendipity",
    ...
    usage:
      "Often used to describe fortunate discoveries or events that happen by accident.",
  },
};

async function getDefinition(word: string): Promise<DictionaryResponse> {
  // Simulate API delay
